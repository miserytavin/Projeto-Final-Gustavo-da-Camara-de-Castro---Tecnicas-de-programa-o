...
-- Table `Spa`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spa`.`cliente` (
...
-- -----------------------------------------------------
-- Table `Spa`.`funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spa`.`funcionario` (
...
-- Table `Spa`.`marca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spa`.`marca` (
...
-- Table `Spa`.`modelo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spa`.`modelo` (
...
-- Table `Spa`.`venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Spa`.`venda` (
  ...
  CONSTRAINT `fk_venda_cliente1`
    ...
    REFERENCES `Spa`.`cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_funcionario1`
    FOREIGN KEY (`funcionario_id_funcionario`)
    REFERENCES `Spa`.`funcionario` (`id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_modelo1`
    FOREIGN KEY (`modelo_id_modelo`)
    REFERENCES `Spa`.`modelo` (`id_modelo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
